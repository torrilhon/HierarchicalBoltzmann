/*************************************************************************\
 SystemNSF.cpp  - implements setup of linear Navier-Stokes-Fourier
\*************************************************************************/
#include <stdio.h>
#include <iostream>
#include <math.h>
...
// main system setup, maybe adjusted by user  
  ...
  p0 = 0.23;    // pressure constant
  A0 = 0.0;     // for heat source
  A1 = 0.0;     // for heat source
  A2 = 0.0;     // for heat source
